...
def main():
    ...
    parser.add_argument("--json", type=str, help="Output file for JSON data (e.g. deals.json)")
    ...
    if args.json:
        ...
        print(f"\n[+] Saved {len(deals)} deals to {args.json}")
        
    # Always print to console unless only purely automation (but user likes to see output)
    if deals:
